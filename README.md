...
I use [Nerfstudio](https://docs.nerf.studio/quickstart/installation.html) for rendering the gaussian splats, and use original GS repo code for evaluating metrics. For rendering and evaluation, run:
