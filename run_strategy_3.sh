...
cp -r NAFNet/deblur_output/* SPSR/img_dataset
cd SPSR
...
mkdir strategy_1_results
cp -r SPSR/superresolution_output/* strategy_1_results


cd esrganchmod u+x realesrgan-ncnn-vulkan
...
mkdir strategy_2_results
cp -r SPSR/superresolution_output/* strategy_2_results

python poisson_blend.py
...
mkdir dataset/input
cp -r combined_imgs/* dataset/input
